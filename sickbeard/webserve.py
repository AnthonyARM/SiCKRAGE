...
class HomeChangeLog(Home):
    ...
    def index(self):
        try:
            changes = helpers.getURL('https://sickrage.github.io/sickrage-news/CHANGES.md', session=requests.Session())
        except Exception:
            logger.log(u'Could not load changes from repo, giving a link!', logger.DEBUG)
            changes = 'Could not load changes from the repo. [Click here for CHANGES.md](https://sickrage.github.io/sickrage-news/CHANGES.md)'
